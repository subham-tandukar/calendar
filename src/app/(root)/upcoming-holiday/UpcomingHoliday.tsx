...
const UpcomingHoliday = ({ currentdate }) => {
    ...
    //     const holidayapi = `${process.env.NEXT_PUBLIC_BASE_URL}/api/v1/calendar/upcoming?type=holidays&year=${submitYear}&months=${submitMonth},${submitNextMonth}`;
    ...
    const { data: fetchedData, isLoading, error } = useSWR(`${process.env.NEXT_PUBLIC_BASE_URL}/api/v1/calendar/upcoming?type=holidays&year=${submitYear}&months=${submitMonth},${submitNextMonth}`,
        fetcher
    );
            ...
            <div className="okv4-container">
                <div className="ok-breadcrumb">
                    <ul>
                        ...
                        <li className='active'>
                            {siteSetting.upcoming_holidays_title_np}
                        </li>
                    </ul>
                </div>
                ...
                <div className="ok-bg">
                    <div className="ok-desc-content ">
                        ...
                        <div className="ok-tab-flex">
                            ...
                            <Share
                                endpoint="upcoming-holiday"
                                title={siteSetting?.upcoming_holiday_meta_title || siteSetting?.upcoming_holidays_title_np}
                                preFilledText={siteSetting?.upcoming_holiday_additional_meta_information || siteSetting?.upcoming_holidays_title_np}
                                imageUrl={`${siteSetting?.upcoming_holiday_og_image || siteSetting?.site_og_image}`}
                            />
                        </div>
                        <div className="ok-content mt-1">
                            <p
                                dangerouslySetInnerHTML={{ __html: siteSetting.upcoming_holidays_description_np }}
                            />
                        </div>
                    </div>
