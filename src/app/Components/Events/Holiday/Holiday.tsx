    ...
    <>
      <div className="ok-block ok-block-leftbar-events">
        <div className="ok-block-heading">
          <h3>{siteSetting.upcoming_holidays_title_np}</h3>
          <div className="ok-block-heading-right-elem">
            <Link href="/upcoming-holiday" className="ok-view-all-btn">
        ...
        <div className=''>
          {dataToShow && dataToShow.length > 0 ? (
            dataToShow.map((holiday) => {
              ...
              return (
                <div key={holiday.id} className={`ok-card-day-event ${holiday.is_public_holiday === true ? 'is-holiday' : ''}`}>
